...
-- ─────────────────────────────────────────────────────────────────────────────
-- Avatar URLs use DiceBear Thumbs style with cat-themed seeds for cute cartoon avatars.
-- — deterministic by seed name, diverse, App Store safe.
-- ─────────────────────────────────────────────────────────────────────────────

-- u01: Alex Chen — alex.chen@hoptrack.test
UPDATE public.profiles
SET
  avatar_url = 'https://api.dicebear.com/7.x/thumbs/svg?seed=Whiskers',
...
UPDATE public.profiles
SET
  avatar_url = 'https://api.dicebear.com/7.x/thumbs/svg?seed=Mittens',
...
UPDATE public.profiles
SET
  avatar_url = 'https://api.dicebear.com/7.x/thumbs/svg?seed=Luna',
...
UPDATE public.profiles
SET
  avatar_url = 'https://api.dicebear.com/7.x/thumbs/svg?seed=Mochi',
...
UPDATE public.profiles
SET
  avatar_url = 'https://api.dicebear.com/7.x/thumbs/svg?seed=Biscuit',
...
UPDATE public.profiles
SET
  avatar_url = 'https://api.dicebear.com/7.x/thumbs/svg?seed=Noodle',
...
UPDATE public.profiles
SET
  avatar_url = 'https://api.dicebear.com/7.x/thumbs/svg?seed=Pepper',
...
UPDATE public.profiles
SET
  avatar_url = 'https://api.dicebear.com/7.x/thumbs/svg?seed=Ginger',
...
UPDATE public.profiles
SET
  avatar_url = 'https://api.dicebear.com/7.x/thumbs/svg?seed=Salem',
...
UPDATE public.profiles
SET
  avatar_url = 'https://api.dicebear.com/7.x/thumbs/svg?seed=Tofu',
...
UPDATE public.profiles
SET
  avatar_url = 'https://api.dicebear.com/7.x/thumbs/svg?seed=Cleo',
...
UPDATE public.profiles
SET
  avatar_url = 'https://api.dicebear.com/7.x/thumbs/svg?seed=Olive',
