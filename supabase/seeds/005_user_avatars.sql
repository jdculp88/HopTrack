...
-- ─────────────────────────────────────────────────────────────────────────────
-- Avatar URLs use DiceBear Avataaars (https://api.dicebear.com/7.x/avataaars/svg)
-- — deterministic, safe for App Store, no real photos.
-- ─────────────────────────────────────────────────────────────────────────────
...
UPDATE public.profiles
SET
  avatar_url = 'https://api.dicebear.com/7.x/avataaars/svg?seed=marcusjohnson',
...
UPDATE public.profiles
SET
  avatar_url = 'https://api.dicebear.com/7.x/avataaars/svg?seed=derekwalsh',
...
UPDATE public.profiles
SET
  avatar_url = 'https://api.dicebear.com/7.x/avataaars/svg?seed=samrivera',
...
UPDATE public.profiles
SET
  avatar_url = 'https://api.dicebear.com/7.x/avataaars/svg?seed=lindako',
...
UPDATE public.profiles
SET
  avatar_url = 'https://api.dicebear.com/7.x/avataaars/svg?seed=tomnguyen',
...
UPDATE public.profiles
SET
  avatar_url = 'https://api.dicebear.com/7.x/avataaars/svg?seed=jessicablake',
...
UPDATE public.profiles
SET
  avatar_url = 'https://api.dicebear.com/7.x/avataaars/svg?seed=carlosmendez',
...
UPDATE public.profiles
SET
  avatar_url = 'https://api.dicebear.com/7.x/avataaars/svg?seed=rachelfoster',
...
UPDATE public.profiles
SET
  avatar_url = 'https://api.dicebear.com/7.x/avataaars/svg?seed=jamesotoole',
...
UPDATE public.profiles
SET
  avatar_url = 'https://api.dicebear.com/7.x/avataaars/svg?seed=ninasharma',
