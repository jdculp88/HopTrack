...
/**
 * Google OAuth button — Sprint 134 (The Tidy)
 *
 * Replaces identical Google sign-in buttons in login + signup pages.
 */
...
export function GoogleOAuthButton({ onClick, label = "Continue with Google" }: GoogleOAuthButtonProps) {
  return (
    <button
      onClick={onClick}
