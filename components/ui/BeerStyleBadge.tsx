...
const STYLE_COLORS: Record<string, { bg: string; text: string; border: string }> = {
  "IPA":               { bg: "rgba(232,132,26,0.15)", text: "#E8841A", border: "rgba(232,132,26,0.3)" },
  "Double IPA":        { bg: "rgba(232,132,26,0.2)",  text: "#E8841A", border: "rgba(232,132,26,0.4)" },
  "Hazy IPA":          { bg: "rgba(212,168,67,0.15)", text: "#D4A843", border: "rgba(212,168,67,0.3)" },
  "Session IPA":       { bg: "rgba(232,132,26,0.12)", text: "#E8841A", border: "rgba(232,132,26,0.25)" },
  ...
  "Lager":             { bg: "rgba(240,220,150,0.12)", text: "#D4A843", border: "rgba(240,220,150,0.25)" },
  ...
  "Belgian":           { bg: "rgba(200,170,80,0.15)", text: "#D4A843", border: "rgba(200,170,80,0.3)" },
