...
// StatsTab — Sprint 160 (The Flow)
// Shows drinker stats: Quick Stats, Level+XP, DrinkerStatsCard, BeerDNA, ActivityHeatmap.
    ...
    <div className="space-y-6">
      ...
      <div className="card-bg-stats border border-[var(--border)] rounded-2xl p-4">
        <div className="grid grid-cols-4 gap-2">
          ...
          >
            <p className="font-mono font-bold text-xl leading-none text-[var(--accent-gold)]">{total_checkins}</p>
          ...
          <div
            ...
            style={{ background: "color-mix(in srgb, var(--surface-2) 55%, transparent)" }}
          >
            <p className="font-mono font-bold text-xl leading-none text-[var(--accent-gold)]">{unique_beers}</p>
          ...
          <div
            ...
            style={{ background: "color-mix(in srgb, var(--surface-2) 55%, transparent)" }}
          >
            <p className="font-mono font-bold text-xl leading-none text-[var(--accent-gold)]">{unique_breweries}</p>
