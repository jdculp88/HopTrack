...
export const FEATURE_MATRIX = [
  ...
  { feature: "Brewery Health Score", free: false, tap: true, cask: true, barrel: true, category: "Analytics" },
  { feature: "Customer win-back intelligence", free: false, tap: false, cask: true, barrel: true, category: "Marketing" },
  { feature: "Peer benchmarking", free: false, tap: false, cask: true, barrel: true, category: "Analytics" },
